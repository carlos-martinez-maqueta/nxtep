...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-11-2023 a las 09:03:48
...
INSERT INTO `tbl_areas` (`id_area`, `descripcion_area`, `title_area`) VALUES
(1, 'Product', 'Product'),
(2, 'Growth', 'Growth'),
...
(22, 'Mathias', 'Martinez', '200', '8', 'Analista de Sistemas', 'EBIZ', 'Link', '5', '3', NULL, 'uploads/6563b1722b587_unsplash_cEnSr1WRHUY.png', 'uploads/6563b1722b58d_image_15.png'),
...
(24, 'vv', 'Martinez', '200', '9', 'Analista de Sistemas', 'EBIZ', 'Link', '5', '5', NULL, 'uploads/6563b1722b587_unsplash_cEnSr1WRHUY.png', 'uploads/6563b1722b58d_image_15.png'),
(25, 'Angel', 'Yaranga', '100', '10', 'Dev', 'Bitel', 'https://www.linkedin.com/in/angel-yaranga-garcia/', '2', '1', NULL, 'uploads/65640fae88b4c_IMG_20190203_170948_(2).jpg', 'uploads/65640fae88b53_28Julio.png');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `tbl_mentores_areas`
--

CREATE TABLE `tbl_mentores_areas` (
  `mentor_id` int(11) DEFAULT NULL,
  `area_id` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Volcado de datos para la tabla `tbl_mentores_areas`
--

INSERT INTO `tbl_mentores_areas` (`mentor_id`, `area_id`) VALUES
(25, 2),
(9, 3),
(25, 4),
(10, 5),
...
--
-- Estructura de tabla para la tabla `tbl_mentores_temas`
--

CREATE TABLE `tbl_mentores_temas` (
  `mentor_id` int(11) DEFAULT NULL,
...
--
-- Indices de la tabla `tbl_mentores_areas`
--
ALTER TABLE `tbl_mentores_areas`
  ADD KEY `area_id` (`area_id`),
  ADD KEY `mentor_id` (`mentor_id`);

--
-- Indices de la tabla `tbl_mentores_temas`
--
ALTER TABLE `tbl_mentores_temas`
  ADD KEY `mentor_id` (`mentor_id`),
...
--
-- Filtros para la tabla `tbl_mentores_areas`
--
ALTER TABLE `tbl_mentores_areas`
  ADD CONSTRAINT `tbl_mentores_areas_ibfk_1` FOREIGN KEY (`area_id`) REFERENCES `tbl_areas` (`id_area`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `tbl_mentores_areas_ibfk_2` FOREIGN KEY (`mentor_id`) REFERENCES `tbl_mentores` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;

--
-- Filtros para la tabla `tbl_mentores_temas`
--
ALTER TABLE `tbl_mentores_temas`
  ADD CONSTRAINT `tbl_mentores_temas_ibfk_1` FOREIGN KEY (`mentor_id`) REFERENCES `tbl_mentores` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `tbl_mentores_temas_ibfk_2` FOREIGN KEY (`tema_id`) REFERENCES `tbl_temas` (`id_tema`) ON DELETE SET NULL ON UPDATE CASCADE;
COMMIT;
